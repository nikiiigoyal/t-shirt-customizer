...
export const App = ({ position = [0, 0, 2.5], fov = 25 }) => (
  <Canvas 
  //  enables shadows across the entire scene
  shadows 
  camera={{ position, fov }} 
  // to capture 3d event
  ...
  eventSource={document.getElementById('root')} eventPrefix="client">
    {/* non-directional light so that no part of the shirt is completely dark. */}
    <ambientLight intensity={0.5 * Math.PI} />
    <Environment files="https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/potsdamer_platz_1k.hdr" />
    {/* controller component that manages the camera postitin an rotation of the objects inside it */}
    <CameraRig>
      <Backdrop />
      <Center>
        <Shirt />
...
// provides env ground and lighting effects
function Backdrop() {
...
// users choices colors and decals
...
// this look main 3d tshirt modal from glb file return nodes and material how model looks
